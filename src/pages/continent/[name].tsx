  ...
  return (
    <Box as="main" pb="10">
      <Box bgImage="/images/europa.jpg" bgSize="cover" bgPos="center" h={500} align="flex-end" pb="16">
        <Flex w="100%" maxW={1240} mx="auto" align="flex-end" h="100%">
          <Heading as="h1" color="gray.50" fontSize="5xl" fontWeight="semibold">
            Europa
          </Heading>
        </Flex>
      </Box>
      ...
      <Box w="100%" maxW={1240} mx="auto">
        <Flex mt="20" justify="space-between" align="center">
          <Text maxW={600} fontSize="2xl" textAlign="justify">
          ...
          <Flex justify="space-between" w="100%" pl="16">
            <Flex flexDir="column" align="center">
              <Text as="span" color="yellow.200" fontSize="5xl" fontWeight="semibold">
                50
              </Text>
            ...
            <Flex flexDir="column" align="center">
              ...
              <Flex align="center">
                <Text as="span" fontSize="2xl" fontWeight="semibold" mr="1.5">
                  cidades +10
                </Text>
        ...
        <Box mt="20">
          <Heading fontWeight="medium" fontSize="4xl">Cidades +100</Heading>
